...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dqv72u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dqv72u.containers.anotherwebservice.com/
...
```
git clone git@github.com:ladazkalii/container-dqv72u.git
cd container-dqv72u
```
...
```
docker attach container-dqv72u
```
